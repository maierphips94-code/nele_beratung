          ...
          <div className="flex items-center gap-3">
            ...
            {!isHeroMode && (
              <button
                ...
                className="md:hidden p-2 text-text-main-light"
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-40 pt-24 bg-background-light/98 backdrop-blur-lg flex flex-col items-center justify-center gap-8"
          >
            {navLinks.map((link, i) => (
              <motion.div
                key={link.href}
              ...
              >
                <Link
                  to={link.href}
                  className={`font-display text-4xl italic font-semibold ${
