...
const serviceCards = [
  ...
  },
  {
    ...
    description:
      'An einem Scheideweg – beruflich oder persönlich? Systemisches Coaching hilft Ihnen, Orientierung zu finden, eigene Antworten zu entwickeln und Ihre nächsten Schritte klar zu sehen.',
...
export default function Home() {
  return (
    <div className="overflow-hidden">
      {/* ── HERO ── */}
      <section className="relative min-h-[100dvh] flex flex-col md:flex-row md:items-center overflow-hidden">
        ...
        {/* Content */}
        <div className="relative z-10 container mx-auto px-6 pt-56 pb-12 flex flex-col flex-1 md:block md:py-40">
          <div className="max-w-2xl flex flex-col flex-1 md:block">
            <motion.div
            ...
            <motion.h1
              ...
              className="font-display text-4xl md:text-5xl leading-tight mb-12 italic text-white"
            >
              Ihr Raum für<br/>
              echte Veränderung.
            </motion.h1>
            ...
            >
              Professionelle systemische Beratung für Einzelpersonen, Paare und Teams. Gewinnen Sie Klarheit, Perspektiven und Selbstwirksamkeit – ganz persönlich, Online oder vor Ort.
            </motion.p>
            ...
            <motion.div
              ...
              className="mt-auto md:mt-0 pb-10 md:pb-0 flex flex-wrap items-center gap-6 justify-center md:justify-start"
            >
              <Link
                to="/kontakt"
        ...
        <div className="container mx-auto px-6">
          <FadeIn>
            <div className="mb-16 max-w-2xl">
              <h2 className="font-display text-4xl md:text-5xl mb-6 italic text-text-main-light">Meine Angebote</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {serviceCards.map((card, i) => (
              <FadeIn key={card.title} delay={i * 0.1}>
                <Link to={card.href} className="group relative rounded-[30px] overflow-hidden block h-[450px]">
                  <img
                    src={card.image}
                    alt={card.title}
      ...
      <section className="container mx-auto px-6 py-24 lg:py-32 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <FadeIn direction="right">
          <div className="grid grid-cols-2 gap-6 relative">
            ...
            <div className="flex flex-col gap-6">
              ...
              <img
                src="./nymphenburg.jpg"
                alt="Schloss Nymphenburg – München"
        ...
        <div className="lg:pl-8">
          ...
          <FadeIn delay={0.2}>
            <h2 className="font-display text-4xl md:text-5xl mb-8 italic text-text-main-light leading-tight">
        ...
        <div className="container mx-auto px-6">
          <FadeIn>
            <div className="text-center mb-14 max-w-2xl mx-auto">
              ...
              <h2 className="font-display text-4xl md:text-5xl italic text-text-main-light">Was Klient:innen sagen</h2>
            </div>
          </FadeIn>
          ...
          <FadeIn>
            <div className="bg-primary rounded-xl px-8 py-10 text-center shadow-xl">
              ...
              <p className="text-white/80 mb-8 max-w-xl mx-auto leading-relaxed">
                Bereit zu erkunden, wie systemische Beratung Ihre Welt verändern kann? Das kostenlose Erstgespräch (20 Min.) ist der erste Schritt.
              </p>
              <Link
                to="/kontakt"
